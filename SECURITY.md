...
Broker admin APIs require metadata-backed users and signed bearer tokens. Bootstrap the first `admin` user locally on the broker host, store strong passwords, and expose the broker only through TLS.
